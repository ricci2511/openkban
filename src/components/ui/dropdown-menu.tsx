...
const DropdownMenuItem = React.forwardRef<
    ...
    DropdownMenuItemPropsWithoutRef & {
        destructive?: boolean; // for dropdown items there is either the default or destructive variant
        inset?: boolean;
    }
>(({ className, destructive, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
            'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-popover-foreground/10 focus:text-popover-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
            destructive &&
